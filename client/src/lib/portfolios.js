...
export const DEFAULT_PRICE = {
  ...
  '379810': 24450, // KODEX 미국나스닥100TR (자투리 메우기)
}

// 자투리 메우기용 보조 종목: 비싼 TIGER 미국나스닥100(133690, 1주 ~20만원) 매수 후
// 남는 돈을 같은 지수의 저가 ETF(KODEX 미국나스닥100TR)로 정수 주수만큼 더 담는다.
// TR(분배 없음)이라 연금계좌에서 세금 드래그가 없다.
export const FRACTIONAL_NASDAQ = {
  forTicker: '133690',
  ticker: '379810',
